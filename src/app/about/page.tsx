...
const About = () => {
  return (
    <div className='pt-16 pb-16 bg-[#050709]' >
           <div className='mt-7'><SectionHeading>About Me</SectionHeading></div>
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20'>
        ...
        <div data-aos="fade-left" data-aos-anchor-placement="top-center" >
          <h1 className='text-bg text-[26px] sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-200  '>
            ...
            <div className='mt-8'>
              <div className='flex items-center space-x-2 mb-6'>
                ...
                <p className='text-sm sm:text-base md:text-lg font-bold text-gray-300'>Front-end Development</p>
              </div>
              ...
              <div className='flex items-center space-x-2 mb-6'>
                ...
                <p className='text-sm sm:text-base md:text-lg font-bold text-gray-300'>Responsive Web Design</p>
              </div>
              ...
              <div className='flex items-center space-x-2 mb-6'>
                ...
                <p className='text-sm sm:text-base md:text-lg font-bold text-gray-300'>Interactive User Experiences</p>
              </div>
            </div>
         ...
         <div data-aos="zoom-in"
          ...
          data-aos-delay="150"
          className='grid grid-cols-2 gap-16 items-center lg:mx-auto mb-11'>
          {/* 1st state */}
          <div>
            ...
            <p className='text-base sm:text-lg text-gray-400 text-center'>Satisfied Costomers</p>
          </div>
          {/* 2nd state */}
          <div>
